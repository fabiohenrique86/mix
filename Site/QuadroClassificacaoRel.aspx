<%@ Page Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="QuadroClassificacaoRel.aspx.cs"
    Inherits="Site.QuadroClassificacaoRel" Title="RELATÓRIO - QUADRO DE CLASSIFICAÇÃO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="imbVisualizar">
                <div id="conteudo">
                    <div id="topo_cabeca">
                        RELATÓRIO - QUADRO DE CLASSIFICAÇÃO
                    </div>
    ...
    <cc1:ModalPopupExtender ID="mpeQuadroClassificacao" runat="server" CancelControlID="imbFechar"
    ...
    <asp:Panel ID="pnlRelatorio" runat="server" CssClass="window_modal" Width="740px"
        ...
        <rsweb:ReportViewer ID="rpvQuadroClassificacao" runat="server" Width="740px" Font-Names="Verdana"
