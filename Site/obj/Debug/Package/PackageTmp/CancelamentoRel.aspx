<%@ Page Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="CancelamentoRel.aspx.cs"
    Inherits="Site.CancelamentoRel" Title="RELATÓRIO - CANCELAMENTO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <cc1:ModalPopupExtender ID="mpeCancelamento" runat="server" CancelControlID="imbFechar"
    ...
    <asp:Panel ID="pnlRelatorio" runat="server" CssClass="window_modal" Width="740px"
        ...
        <rsweb:ReportViewer ID="rpvCancelamento" runat="server" Width="740px" Font-Names="Verdana"
