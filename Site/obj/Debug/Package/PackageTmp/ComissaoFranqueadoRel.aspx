<%@ Page Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="ComissaoFranqueadoRel.aspx.cs"
    Inherits="Site.ComissaoFranqueadoRel" Title="RELATÓRIO - COMISSÃO - POR FRANQUEADO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="imbVisualizar">
                <div id="conteudo">
                    <div id="topo_cabeca">
                        RELATÓRIO - COMISSÃO - POR FRANQUEADO
                    </div>
    ...
    <cc1:ModalPopupExtender ID="mpeComissaoFranqueado" runat="server" CancelControlID="imbFechar"
    ...
    <asp:Panel ID="pnlRelatorio" runat="server" CssClass="window_modal" Width="740px"
        ...
        <rsweb:ReportViewer ID="rpvComissaoFranqueado" runat="server" Width="740px" Font-Names="Verdana"
