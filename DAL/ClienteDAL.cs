...
namespace DAL
{
    ...
    {
        // Methods
        public void Atualizar(ClientePFDAO clientePF)
        {
            Database db;
            try
            {
                ...
                using (DbCommand cmd = db.GetStoredProcCommand("dbo.spAtualizarClientePF"))
                {
                    ...
                    db.AddInParameter(cmd, "@Email", DbType.String, clientePF.Email);
                    db.AddInParameter(cmd, "@Cep", DbType.String, clientePF.Cep);
        ...
        public void Atualizar(ClientePJDAO clientePJ)
        {
            Database db;
            try
            {
                ...
                using (DbCommand cmd = db.GetStoredProcCommand("dbo.spAtualizarClientePJ"))
                {
                    ...
                    db.AddInParameter(cmd, "@Email", DbType.String, clientePJ.Email);
                    db.AddInParameter(cmd, "@Cep", DbType.String, clientePJ.Cep);
        ...
        public void Inserir(ClientePFDAO clientePF)
        {
            Database db;
            try
            {
        ...
        public void Inserir(ClientePJDAO clientePJ)
        {
            Database db;
            try
            {
        ...
        public DataSet Listar(ClientePFDAO clientePF)
        {
            Database db;
            DataSet ds;
            try
        ...
        public DataSet Listar(ClientePJDAO clientePJ)
        {
            Database db;
            DataSet ds;
            try
