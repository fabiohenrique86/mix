...
namespace DAL
{
    ...
    {
        // Methods
        public static void Atualizar(DAO.Funcionario funcionario)
        {
            Database db;
            try
            {
        ...
        public static void Excluir(DAO.Funcionario funcionario)
        {
            Database db;
            try
            {
        ...
        public static void Inserir(DAO.Funcionario funcionario)
        {
            Database db;
            try
            {
