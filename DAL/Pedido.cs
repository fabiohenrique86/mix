...
namespace DAL
{
    public class Pedido
    {
        public void Atualizar(int pedidoId, string produtoIId, string quantidadeI, string medidaI, string preco, int sistemaId)
        {
            Database db;
            try
            {
        ...
        public void Atualizar(int pedidoId, string produtoEId, string quantidadeE, string medidaE, string produtoIId, string quantidadeI, string medidaI, string preco, string observacao, int sistemaId)
        {
            Database db;
            try
            {
        ...
        public void Excluir(int pedidoId, int tipoPagamentoId, int parcelaId, decimal valor, int sistemaId)
        {
            Database db;
            try
            {
        ...
        public bool Existe(int? pedidoId, int sistemaId)
        {
            Database db;
            bool pedido = false;
            try
        ...
        public void Inserir(DAO.Pedido pedido)
        {
            ...
            try
            {
                ...
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, transactionOptions))
                {
                    ...
                    {
                        cmd.CommandTimeout = 300;
                        db.AddInParameter(cmd, "@PedidoID", DbType.Int32, pedido.PedidoID);
                    ...
                    {
                        cmd.CommandTimeout = 300;
                        foreach (DAO.Produto produto in pedido.ListaProduto)
                        {
                    ...
                    {
                        cmd.CommandTimeout = 300;
                        foreach (DAO.TipoPagamento tipoPagamento in pedido.ListaTipoPagamento)
                        {
                            cmd.Parameters.Clear();
                            db.AddInParameter(cmd, "@PedidoID", DbType.Int32, pedido.PedidoID);
        ...
        public void Inserir(int orcamentoId, int pedidoId, int clienteId, string dataPedido, string observacao, int sistemaId)
        {
            Database db;
            try
            {
        ...
        public DataSet Listar(int? pedidoId, int? lojaId, int? lojaOrigemId, int? funcionarioId, string cpf, string cnpj, DateTime? dataPedido, int sistemaId)
        {
            Database db;
            DataSet ds;
            try
        ...
        public DataSet ListarByFiltro(DAO.Pedido pedido)
        {
            Database db;
            DataSet ds;
            try
        ...
        public DataTable ListarComanda(int pedidoId, int sistemaId, string pedidoOuReserva)
        {
            Database db;
            DataTable dt;
            try
        ...
        public DataSet ListarDetalhe(int pedidoId, int sistemaId)
        {
            Database db;
            DataSet ds;
            try
        ...
        public bool ListarTipoPagamento(int pedidoId, int tipoPagamentoId, int sistemaId)
        {
            Database db;
        ...
        public DataSet ListarValorPedido(int pedidoId, int sistemaId)
        {
            Database db;
            DataSet ds;
            try
        ...
        public DataSet ListarValorPedidoAlterado(int pedidoId, decimal totalPedido, int sistemaId)
        {
            Database db;
            DataSet ds;
            try
