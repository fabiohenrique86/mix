...
namespace BLL
{
    public static class UtilitarioBLL
    {
        ...
        public static string COR_STATUS_OK = "#65b765";
        public static string COR_STATUS_TRANSITO = "#ffb732";
        public static string COR_STATUS_PENDENTE = "#df6565";
        ...
        public static void ExibirMensagemAjax(Page pagina, string mensagem, Exception ex = null)
        {
            if ((ex != null) && !(ex is System.Threading.ThreadAbortException))
            {
                try
                {
                    ...
                    if (ConfigurationManager.AppSettings["EnviarEmailErro"] != null && ConfigurationManager.AppSettings["EnviarEmailErro"] == "S")
                    { 
                        EmailBLL.Enviar("MiX", "contato@sistemamix.com.br", message, "Erro Crítico");
                    }
                }
                catch (Exception)
                {
