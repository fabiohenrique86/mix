...
namespace DAO
{
    ...
    public class ProdutoDAO
    {
        ...
        public int SobMedida { get; set; }
        public long CodigoSobMedida { get; set; }
        ...
        public ProdutoDAO(long produtoId, short quantidade, int sistemaId)
        {
        ...
        public ProdutoDAO(long produtoId, int lojaId, int sistemaId)
        {
            this.ProdutoID = produtoId;
        ...
        public ProdutoDAO(long produtoId, short quantidade, string medida, decimal preco, int sistemaId)
        {
            this.ProdutoID = produtoId;
            this.Quantidade = new short?(quantidade);
            this.Medida = medida;
        ...
        public ProdutoDAO(long produtoId, int lojaId, int linhaId, short comissaoFuncionario, short comissaoFranqueado, string descricao, int medidaId, short quantidade, int sistemaId)
        {
            this.ProdutoID = produtoId;
            this.LojaID = new int?(lojaId);
