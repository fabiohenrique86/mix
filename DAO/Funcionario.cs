...
namespace DAO
{
    public class Funcionario
    {
        ...
        public Funcionario(int funcionarioId, int sistemaId)
        {
            this.FuncionarioID = new int?(funcionarioId);
            this.SistemaID = sistemaId;
        }

        public Funcionario(int? funcionarioId, string nome, int? lojaId, string telefone, string email, int sistemaId)
        {
